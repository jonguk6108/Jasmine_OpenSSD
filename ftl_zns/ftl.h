...
#define TL_BUFFER_BYTES		((MAX_OPEN_ZONE * BYTES_PER_PAGE + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
...
#define TLOPEN_ZONE_Q_ADDR 	ZONE_TO_ID_ADDR + ZONE_TO_ID_BYTES
#define TLOPEN_ZONE_Q_BYTES	MAX_OPEN_ZONE * sizeof(UINT8)

#define ZONE_TO_TL_ID_ADDR	TLOPEN_ZONE_Q_ADDR + TLOPEN_ZONE_Q_BYTES
#define ZONE_TO_TL_ID_BYTES	MAX_OPEN_ZONE * sizeof(UINT8)
*/

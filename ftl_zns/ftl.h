...
#define ZONE_BUFFER_BYTES	((NBLK * SECTORS_PER_PAGE * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
...
#define TL_BUFFER_BYTES		((NBLK * SECTORS_PER_PAGE * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

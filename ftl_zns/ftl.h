...
#define DRAM_BYTES_OTHER	((NUM_COPY_BUFFERS + NUM_FTL_BUFFERS + NUM_HIL_BUFFERS + NUM_TEMP_BUFFERS) * BYTES_PER_PAGE + BAD_BLK_BMP_BYTES + PAGE_MAP_BYTES + VCOUNT_BYTES + ZONE_STATE_BYTES + ZONE_WP_BYTES + ZONE_SLBA_BYTES +ZONE_BUFFER_BYTES +ZONE_TO_FBG_BYTES + FBQ_BYTES)
...
#define DRAM_TOP			FBQ_ADDR + FBQ_BYTES
	
// ZNS+
/*

#define TL_BITMAP_ADDR		(FBQ_ADDR + FBQ_BYTES)
#define TL_BITMAP_BYTES		((NBLK * (NPAGE*DEG_ZONE + 1) * sizeof(UINT8) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
...
#define TL_BUFFER_BYTES		((NBLK * BYTES_PER_PAGE + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define TL_NUM_ADDR			(TL_BUFFER_ADDR + TL_BUFFER_BYTES)

...
+ BAD_BLK_BMP_BYTES + PAGE_MAP_BYTES + VCOUNT_BYTES + ZONE_STATE_BYTES + ZONE_WP_BYTES + ZONE_SLBA_BYTES +ZONE_BUFFER_BYTES +ZONE_TO_FBG_BYTES + FBQ_BYTES)
...
#define ZONE_STATE_BYTES	((VBLKS_PER_BANK * sizeof(UINT8) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
#define ZONE_WP_ADDR		(ZONE_STATE_ADDR + ZONE_STATE_BYTES)
#define ZONE_WP_BYTES		((VBLKS_PER_BANK * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
#define ZONE_SLBA_ADDR		(ZONE_WP_ADDR + ZONE_WP_BYTES)
#define ZONE_SLBA_BYTES		((VBLKS_PER_BANK * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define ZONE_BUFFER_ADDR	(ZONE_SLBA_ADDR + ZONE_SLBA_BYTES)
#define ZONE_BUFFER_BYTES	((VBLKS_PER_BANK * SECTORS_PER_PAGE * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define ZONE_TO_FBG_ADDR	(ZONE_BUFFER_ADDR + ZONE_BUFFER_BYTES)
#define ZONE_TO_FBG_BYTES	((VBLKS_PER_BANK * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define FBQ_ADDR			(ZONE_TO_FBG_ADDR + ZONE_TO_FBG_BYTES)
#define FBQ_BYTES			((VBLKS_PER_BANK * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
	
// ZNS+
/*

#define TL_BITMAP_ADDR		(FBQ_ADDR + FBQ_BYTES)
#define TL_BITMAP_BYTES		((VBLKS_PER_BANK * (NBANK * SECTORS_PER_PAGE * PAGES_PER_VBLK + 1) * sizeof(UINT8) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define TL_WP_ADDR			(TL_BITMAP_ADDR + TL_BITMAP_BYTES)
#define TL_WP_BYTES			((VBLKS_PER_BANK * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)

#define TL_BUFFER_ADDR		(TL_WP_ADDR + TL_WP_BYTES)
#define TL_BUFFER_BYTES		((VBLKS_PER_BANK * SECTORS_PER_PAGE * sizeof(UINT32) + BYTES_PER_SECTOR - 1) / BYTES_PER_SECTOR * BYTES_PER_SECTOR)
